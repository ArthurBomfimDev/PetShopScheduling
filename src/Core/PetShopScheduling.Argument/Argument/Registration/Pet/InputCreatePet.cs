...
public class InputCreatePet : BaseInputCreate<InputCreatePet>
{
    ...
    [JsonConstructor]
    public InputCreatePet(long customerId, string? identification, EnumSpecieType specieType, string? name, DateOnly? birthDate, string? race, EnumPetSize? petSize, string? observation)
    {
