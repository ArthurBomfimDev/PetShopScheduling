...
public class InputUpdateSchedule : BaseInputUpdate<InputUpdateSchedule>
{
    ...
    public InputUpdateSchedule() { }

    [JsonConstructor]
    public InputUpdateSchedule(long customerId, long petId, bool hasVaccine, List<long>? listVaccineId, bool hasBath, bool hasGromming, EnumGroomingType? groomingType, DateOnly day, DateTime time, string? observation)
    {
